...
class MyTopo( Topo ):
  def __init__( self ):
    ...
    self.addLink( s10, c6, **wide_linkopts )
    self.addLink( s10, c7, **wide_linkopts )
    self.addLink( s10, c8, **wide_linkopts )
    self.addLink( s10, c9, **wide_linkopts )
    self.addLink( s10, c10, **wide_linkopts )
    ...
    self.addLink( p6, s20, **wide_linkopts )
    self.addLink( p7, s20, **wide_linkopts )
    self.addLink( p8, s20, **wide_linkopts )
    self.addLink( p9, s20, **wide_linkopts )
    self.addLink( p10, s20, **wide_linkopts )
...
if __name__ == '__main__':
  ...
  # run_pcnodes([c1, p1, c2, p2, c3, p3, c4, p4, c5, p5])
