...
class MyTopo( Topo ):
  def __init__( self ):
    ...
    self.addLink( s1, c1, **wide_linkopts )
    self.addLink( s1, c2, **wide_linkopts )
    self.addLink( s1, c3, **wide_linkopts )
...
if __name__ == '__main__':
  ...
  cont=net.addController('r0', controller=RemoteController, ip='10.39.1.41', port=6633)
  cont.start()
