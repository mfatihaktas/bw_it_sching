...
P2DEV='p2-eth0'
P2DIR='/home/ubuntu/mininet/mininet_rel/host_rel/tc_rel/htb_rel/p2-eth0_'

C1DEV='c1-$DEV'
C1DIR='/home/ubuntu/mininet/mininet_rel/host_rel/tc_rel/htb_rel'
C2DEV='c2-$DEV'
C2DIR='/home/ubuntu/mininet/mininet_rel/host_rel/tc_rel/htb_rel'

if [ $2  = 'p1' ]; then
  DIR=$P1DIR
  DEV=$P1DEV
  OPT='add_root' #'not_add_root'
elif [ $2  = 'p2' ]; then
  DIR=$P2DIR
  DEV=$P2DEV
  OPT='not_add_root'
